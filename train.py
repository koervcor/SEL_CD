...
def train_model(model, loss_func, optimizer, step_scheduler, num_epochs=100):
    ...
    train_dataset = Dataset(cfg["train_image_path"], train_transform, cfg["image_format"], cfg["delta"])
    valid_dataset = Dataset(cfg["valid_image_path"], valid_transform, cfg["image_format"], cfg["delta"])
    test_dataset = Dataset(cfg["test_image_path"], valid_transform, cfg["image_format"], cfg["delta"])
